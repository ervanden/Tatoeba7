...
import static turkeditor.TurkishEditorFrame.docDict;
...
public class DocUtils {
    ...
    public static void writeSelectDictArea(String str) {
        ...
        StyledDocument docDict = TurkishEditorFrame.docDict;
    ...
    public static void writeDictArea(String s, boolean bold) {
        ...
        if (TurkishEditorFrame.docDict == null) {
            return;
        }

        writeArea(TurkishEditorFrame.docDict, s, bold);
    }

    public static void scrollEnd() {
        JTextPane dictArea = TurkishEditorFrame.dictArea;
